...
class DeliveryUI:
    def __init__(self, chosen_vehicle, delivery_time):
        ...
        self.bike_image = pygame.image.load(
            r"C:\Users\kooju\OneDrive\바탕 화면\잡동사니\오토바이 아이콘.png")
        self.bike_image = pygame.transform.scale(
            self.bike_image, (self.deliver_width, self.deliver_height))

        self.walk_image = pygame.image.load(
            r"C:\Users\kooju\OneDrive\바탕 화면\잡동사니\도보 아이콘.png")
        self.walk_image = pygame.transform.scale(
            self.walk_image, (self.deliver_width, self.deliver_height))

        self.delivery_time = delivery_time
        self.deliver_speed = self.screen_width / \
            (self.deliver_width * self.delivery_time)

        pygame.init()
        self.screen = pygame.display.set_mode(
            (self.screen_width, self.screen_height))
        pygame.display.set_caption("Delivery App")
